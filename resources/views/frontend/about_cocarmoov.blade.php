    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        ...
        <div class="content">
          ...
          <p class="text-dark">Ces services permettent aux clients de faire transporter leurs véhicules d'un point A à un point B sans avoir à les conduire eux-mêmes, ce qui est particulièrement utile pour les personnes déménageant dans une autre région ou les entreprises ayant besoin d’expédier des véhicules.</p>
          <div class="mb-5 text-center">
        <img src="{{ asset('images/wallet/histoire-cocarmoov.png') }}" class="img-fluid rounded" alt="Post Thumbnail">
        </div>
          <h3 class="text-dark text-center">Nos valeurs</h3>
          <div class="mb-5 text-center">
        ...
        <p class="list-inline-item"><a href="#!" class="ml-1">Publié le 04 octobre 2023</a></p><br>
          ...
          <p class="list-inline-item">Catégorie : <a href="#!" class="ml-1">A propos de CoCarmoov</a>
          </p>
          <p class="list-inline-item">Mots clés : <a href="#!" class="ml-1">Expédier un véhicule </a> , <a href="#!"
              ...
              <a href="#!"
              class="ml-1"> Transport premium </a>
              <a href="#!"
              class="ml-1"> Éco-location </a>
              <a href="#!"
              class="ml-1"> Éco-louer </a>
              <a href="#!"
              class="ml-1"> Location partagée</a>
          </p>
        </div>
      </div>
    </div>
