...
<li>- Toyota Prius</li>
        ...
        <div class="mb-5">
          ...
          <p class="list-inline-item">Catégorie : <a href="#!" class="ml-1">Actualité </a>
          </p>
          <p class="list-inline-item">Mots clés : <a href="#!" class="ml-1">Acheter un véhicule </a> , <a href="#!"
              class="ml-1">Salon automobile </a> , <a href="#!"
              class="ml-1"> Véhicules électriques </a>
          </p>
        </div>
      </div>
    </div>
