                    ...
                    <div class="card mx-auto rounded">
                        <div class="card-body">
                            ...
                            <form id="loginForm" method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group">
                                Pas de compte ? <a href="{{ route('register') }}" class="text-muted"><span style="color:#fdcd02"> S’inscrire</span></a>
                                </div>
                                <!-- Login button -->
                                <button type="submit" class="btn btn-warning" style="width:100%;">Réinitialiser</button>
                            </form>
                        </div>
                    </div>
                </div>
