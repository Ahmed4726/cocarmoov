...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <div class="row mx-5 mb-5">
          ...
          <div class="card">
              <div class="card-header">
                ...
                {{-- <button type="button" class="btn btn-primary text-dark text-bold" style="background-color: #FDCD02; border:none;" data-toggle="modal" data-target="#roleModal">Roles</button> --}}
                <button type="button" class="btn btn-primary text-dark text-bold" style="background-color: #FDCD02; border:none;" data-toggle="modal" data-target="#permissionModal">Permissions</button>
        ...
        <!-- Permission Modal -->
        <div class="modal" id="permissionModal" tabindex="-1" role="dialog" aria-labelledby="permissionModalLabel" aria-hidden="true">
          ...
          <tbody>
              @foreach($permissions as $permission)
                  <tr>
                      ...
                      <td>
                          <button class="btn btn-primary btn-sm" onclick="editRole({{ $permission->id }})">Edit</button>
        ...
        <!-- Your custom script for handling Ajax request with SweetAlert -->
        <script>
 $(document).ready(function () {
    ...
    function deleteRole(permissionid) {
