  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 font-monospace">Deliver Car</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Deliver Car</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="{{ route('confirm.delivery') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $pick_up_car->mission_id }}">
                <input type="hidden" name="car_id" value="{{ $pick_up_car->car_id }}">
                <div class="card-body">
                  <div class="form-group">
                    <label for="front_photos">Select Front-side Photos</label>
                    <div id="frontPhotoPreview"></div>
                    <input type="file" class="form-control-file" id="front_photos" name="front_photos" multiple>
                    <!-- Placeholder for front-side photos -->

                  </div>
                  <div class="form-group">
                    <label for="back_photos">Select Back-side Photos</label>
