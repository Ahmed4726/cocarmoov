...
<div class="container-fluid pt-3 pb-4" style="background-color: #333132;">
    ...
    <div class="card rounded">
        <div class="card-body">
            <form id="search_form" name="search_form" action="/check-missions" method="POST" style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
                @csrf
