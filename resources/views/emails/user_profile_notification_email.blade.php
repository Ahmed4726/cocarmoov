...
<head>
    ...
    <title>{{ $user->family_name }} your Profile has been Submitted</title>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 20px;">
                <p>Dear {{ $user->family_name }} Thank You for Submitting Your Details.</p>
                <p>Profile has been received for approval We are looking on it.</p>

                <p>Here is the copy of information you submitted:</p>
