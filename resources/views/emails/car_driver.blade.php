...
<html>
<head>
    <title>You Booking has been done</title>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 20px;">
                ...
                <p>Your Successfully Book this car</p>
                <p>Here are details of Your Booking:</p>
                <ul>
                    <li><strong>Name :</strong> {{ $car_owner->family_name }} </li>
                    <li><strong>Phone #</strong> {{ $car_owner->phone_number }} </li>
                    <li><strong>Email :</strong> {{ $car_owner->email }} </li>
                ...
                <p>Details:</p>
                <ul>
                    <li><strong>Booking Amount:</strong> {{ $listing->package_amount }}</li>
                ...
                <p><strong>Amount also deducted from CarOwner account.</strong></p>
                <p><strong>Note: <br> Amount Available for payout when CarOwner Confirms Delivery.</strong></p>
